...
#pragma omp parallel shared(fields_dot, fieldspl, fieldsmi, parameters, forcing, xdim, ydim, dx, dy, neighbors, lat, lon, print_out_order, fields_save, psi, jac, chunk) private(ddim, tid)
        {
